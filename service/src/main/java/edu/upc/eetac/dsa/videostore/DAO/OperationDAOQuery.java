...
public interface OperationDAOQuery {
    ...
    public final static String GET_RENT_BY_BOTH_ID = "select hex(usuarioid) as usuarioid, hex(peliculaid) as peliculaid, horasrestantes, fechacompra from alquiladas where usuarioid=unhex(?) and peliculaid=unhex(?)";
