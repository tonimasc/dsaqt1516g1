...
public interface MovieDAOQuery {
    ...
    public final static String GET_MOVIES_BY_DEST = "select hex(id) as id, titulo, genero, ano, director, descripcion, votos, numdescargaspermitidas, tiempomaximovisualizacion, precioalquiler, preciocompra, fechainclusion from pelicula order by fechainclusion DESC, votos DESC";
