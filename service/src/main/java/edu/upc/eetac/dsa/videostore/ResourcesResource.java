...
public class ResourcesResource {
    ...
    public Response createMovie(@FormParam("peliculaid") String peliculaid, @FormParam("recursopeli") String recursopeli,
                                @FormParam("recursoportada") String recursoportada, @Context UriInfo uriInfo)
        ...
        if (peliculaid == null || recursopeli == null || recursoportada == null)
            throw new BadRequestException("all parameters are mandatory");

        ResourcesDAO resourcesDAO = new ResourcesDAOImpl();
        Resources resources = null;
        try {
            resources = resourcesDAO.createResource(peliculaid, recursopeli, recursoportada);
        }
